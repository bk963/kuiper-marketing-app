...
export default async function Page() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-3xl font-extrabold mb-2">💡 SEO-Vorschläge</h1>
      <p className="text-slate-600 mb-8">Claude-Vorschläge: neuer Artikel / FAQ ergänzen / Internal-Link</p>
